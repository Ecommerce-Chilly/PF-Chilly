                ...
                <div className="container px-5 py-24 mx-auto">
                  <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                      <h2 className="text-sm font-mono  title-font text-gray-500 tracking-widest">
                        {produDetail[0].brand}
                      </h2>
                      ...
                      <div className="flex">
                        ...
                        <button className="flex ml-auto font-semibold text-white bg-main border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded" onClick={() => addCart(produDetail[0].id)}>
                          Add to cart
                        </button>
