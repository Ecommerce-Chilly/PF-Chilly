...
function Home() {
  ...
  return (
    <div>
      ...
      <div className="cats flex max-w-7xl mx-auto font-display">
        <div className="flex flex-col border h-80 w-80">
          <div className="flex flex-col border w-full h-full justify-center text-center">
            ...
            <div className="mt-9">Storage </div>
          </div>
        ...
        <div className="flex flex-col border h-80 w-80">
          <div className="flex flex-col border w-full h-full justify-center text-center">
            ...
            <div className="mt-9">Graphic cards </div>
          </div>
          <div className="flex flex-col border w-full h-full justify-center text-center">
            <div className="mx-auto">
              <svg
            ...
            <div className="mt-9">Monitors </div>
          </div>
        </div>
        <div className="flex flex-col border h-80 w-80">
          <div className="flex flex-col border w-full h-full justify-center text-center">
        ...
        <div className="flex flex-col border h-80 w-80">
          <div className="flex flex-col border w-full h-full justify-center text-center">
            ...
            <div className="mt-9">Processors </div>
          </div>
          ...
          <div className="flex flex-col border w-full h-full justify-center text-center">
            ...
            <div className="mt-9">Motherboards </div>
          </div>
        </div>
        <div className="flex flex-col border h-80 w-80">
          <div className="flex flex-col border w-full h-full justify-center text-center">
            ...
            <div className="mt-9">Headsets </div>
          </div>
          ...
          <div className="flex flex-col border w-full h-full justify-center text-center">
            ...
            <div className="mt-9">Keyboards </div>
          </div>
        </div>
      </div>
      {/* <h2 className="text-center text-3xl text-slate-800 font-bold mt-10 mb-10">
