...
function ArticleCard() {
  return (
    <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-md  ">
      ...
      <p className="mb-3 font-normal text-gray-400 font-display">
      ...
      <a
        href="#"
        className="flex pl-11 m-auto my-7 text-white bg-main border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded w-2/4"
      >
        Read more
      </a>
    </div>
